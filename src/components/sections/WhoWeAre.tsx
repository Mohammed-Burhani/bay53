        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-4 text-[#4b5563] leading-[1.625] text-base">
              ...
              <p>
                Our flagship product, <strong className="font-bold text-[#111827]">Bay53</strong>, is a comprehensive AI-Powered ERP solution designed specifically for Small and Medium Enterprises (SMEs). Bay53 enables businesses to quickly move away from manual processes to a fully integrated business solution.
              </p>
            </div>
          </div>
